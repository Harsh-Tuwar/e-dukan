...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description: "Every asset on our platform is varifies by our team to ensure our highest quality standards. Not happy? We offer a 30 day refund guarantee."
  },
  {
    name: 'For the Planet',
    Icon: Leaf,
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className='mt-6 text-lg max-w-prose text-muted-foreground'>
            Welcome to E-Dukan, Every assset on our platform is verified by
        ...
        <ProductReel title='Brand new' query={{ sort: "desc", limit: 4 }} href='/products'/>
      </MaxWidthWrapper>
...
// cmnd + m = select starting tag to closing tag